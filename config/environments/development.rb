...
config.action_mailer.smtp_settings = {
  ...
  password: 'Bonjour2025@', # Votre mot de passe
  authentication: :login, # Mode d'authentification
  enable_starttls_auto: true, # Active TLS pour sécuriser la connexion
...
config.action_mailer.default_options = { from: 'kklamalice@hotmail.fr' } # L'adresse de l'expéditeur
